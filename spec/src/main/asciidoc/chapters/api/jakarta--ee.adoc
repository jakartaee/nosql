...
Jakarta NoSQL builds on the Jakarta Query Core language, offering a portable and expressive way to perform database operations across NoSQL technologies.
