...
IMPORTANT: Always validate your provider’s capabilities before using advanced expressions or functions. The goal of Jakarta NoSQL is to offer a consistent API while honoring the operational realities and limitations of each NoSQL technology.
