...
insert God (name = "Diana", age = 10, powers = {"sun", "god"})
insert God (name = "Diana", age = 10, powers = {"sun", "god"}) 1 day
insert God {"name": "Diana", "age": 10, "powers": ["hunt", "moon"]}
insert God {"name": "Diana", "age": 10, "powers": ["hunt", "moon"]} 1 day
...
//examples
delete from God
delete power, age from God where name = "Diana"
----
