...
//examples
insert Hero (name = "Diana", age = 10)
insert Hero (name = "Diana", age = 10, powers = {"sun", "moon"})
insert Hero (name = "Diana", age = 10, powers = {"sun", "moon"}) 1 day
insert Hero {"name": "Diana", "age": 10, "powers": ["hunt", "moon"]}
insert Hero {"name": "Diana", "age": 10, "powers": ["hunt", "moon"]} 1 day
...
update_statement ::= update ENTITY_NAME (NAME = VALUE, (`,` NAME = VALUE) *) || JSON
 ...
 //examples
update Hero (name = "Diana", age = 10)
update Hero (name = "Diana", age = 10, power = {"hunt", "moon"})
update Hero {"name": "Diana", "age": 10, "power": ["hunt", "moon"]}
----
...
//examples
delete from Hero
delete power, age from Hero where name = "Diana"
----
...
//examples
select * from Hero
select name, age, adress.age from Hero order by name desc age desc
select * from Hero where birthday between "01-09-1988" and "01-09-1988" and salary = 12
select name, age, adress.age from Hero skip 20 limit 10 order by name desc age desc
----
