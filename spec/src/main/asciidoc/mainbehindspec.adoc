...
image::tiers.png[alt=Tiers from a classic application structure, width=180%]
...
image::nosql_issue.png[alt=A NoSQL Java application that has locking to each NoSQL provider, width=280%]
