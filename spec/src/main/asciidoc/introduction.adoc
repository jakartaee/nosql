...
.Key-value structure
image::key-value.png[alt=key-value structure, width=240%]
...
image::column.png[alt=column family structure, width=240%]
...
.Graph structure
image::graph.png[alt=Graph structure, width=240%]
...
image::graph_deep.png[alt=Graph structure, width=320%]
...
.Scalability vs Complexity
image::scalability_vs_complexity.png[alt=Scalability vs Complexity, width=240%]

=== BASE vs ACID
.BASE vs ACID
image::acid_vs_base.png[alt=BASE vs ACID, width=240%]
...
=== CAP Theorem
.CAP Theorem
image::cap.png[alt=CAP Theorem, width=240%]
