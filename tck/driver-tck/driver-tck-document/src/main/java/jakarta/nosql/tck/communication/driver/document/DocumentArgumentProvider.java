...
public class DocumentArgumentProvider implements ArgumentsProvider, AnnotationConsumer<DocumentSource> {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        ...
        if (map.isEmpty()) {
            return Stream.of(Arguments.of(DocumentArgument.EMPTY));
        }
        ...
        return Stream.of(Arguments.of(new DocumentArgument(query, idName)));
    }
    ...
    public Map<String, String> get() {
        try {
            ...
            InputStream stream = DocumentArgumentProvider.class.getClassLoader()
