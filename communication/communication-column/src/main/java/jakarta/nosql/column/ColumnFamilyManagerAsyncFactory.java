 ...
 */
public interface ColumnFamilyManagerAsyncFactory {
    /**
     * Creates a {@link ColumnFamilyManagerAsync} from database's name
     *
     * @param <T>      the {@link ColumnFamilyManagerAsync} type
     ...
     */
    <T extends ColumnFamilyManagerAsync> T getAsync(String database);
